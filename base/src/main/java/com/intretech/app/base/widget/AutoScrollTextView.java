...
/**
 * Created by yq06171 on 2018/4/12.
 * 自动滚动textview
 */
...
public class AutoScrollTextView extends TextView {
    ...
    /** 显示的文字 */
    private String text = "";
    public AutoScrollTextView.OnMarqueeCompleteListener marqueeCompleteListener;

    public interface OnMarqueeCompleteListener {
        void onMarqueeComplete();
    }

    public AutoScrollTextView.OnMarqueeCompleteListener getMarqueeCompleteListener() {
        return marqueeCompleteListener;
    }

    public void setOnMarqueeCompleteListener(
            AutoScrollTextView.OnMarqueeCompleteListener marqueeCompleteListener) {
